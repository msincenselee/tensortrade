...
class InstrumentExchange(object, metaclass=ABCMeta):
    ...
    def base_precision(self) -> float:
        """The floating point precision of the base instrument. 获取基准合约价格精度（例如USDT的价格精度）"""
    ...
    def instrument_precision(self) -> float:
        """The floating point precision of the instrument to be traded. 获取交易合约的价格精度（price_tick)"""
